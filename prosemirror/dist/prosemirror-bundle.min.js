(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ProseMirror = {}));
  ...
  */
  let Fragment$1 = class Fragment {
      ...
      */
      ...
      (overwritten) the next time the function is called. (Not src.)
      */
  ...
  */
  ...
  editHandlers$1.drop = (view, _event) => {
      ...
      if (slice) {
          ...
          slice = parseFromClipboard$1(view, getText(event.dataTransfer), brokenClipboardAPI$1 ? null : event.dataTransfer.getData("text/html"), false, $mouse);
      }
  ...
  */
  ...
  function captureKeyDown(view, event) {
      ...
      else if ((code == 46 && !event.shiftKey) || (mac$1 && code == 68 && mods == "c")) { // Delete, Ctrl-d on Mac
          return stopNativeHorizontalDelete(view, 1) || skipIgnoredNodes(view, 1);
      }
      else if (code == 13 || code == 27) { // Enter, Esc
          return true;
  ...
  */
  ...
  const reactPropsKey = new PluginKey$1("reactProps");

  const keydownPlugin = new Plugin$1({
      key: reactPropsKey,
      props: {
              ...
              if (event.key === "Backspace") {
                  ...
                  if (parentNodeType === "node_view") {
                      ...
                      if (offsetInParent === 0) {
                          event.preventDefault();
                          const newPos = head - 1;
                          const newSelection = TextSelection$1.create(view.state.doc, newPos);
  ...
  window.view = new EditorView(document.querySelector('#editor'), {
      state: EditorState.create({
          doc: DOMParser$1.fromSchema(mySchema).parse(document.querySelector('#content')),
  ...
  exports.reactPropsKey = reactPropsKey;
